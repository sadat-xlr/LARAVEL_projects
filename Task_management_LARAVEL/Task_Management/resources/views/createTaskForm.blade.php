                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="discription" class=" form-control-label">Description</label><input type="text" id="vat" name="discription" placeholder="Enter description for task" class="form-control"></div>
